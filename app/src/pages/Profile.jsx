...
const Profile = () => {
  ...
  return (
    <IonPage>
     ...
     {/* ४. प्रीमियम फ्लोटिंग बॉटम नेव्हिगेशन बार (Profile Page) */}
<div 
...
>
  ...
  {/* ४. प्रोफाईल बटण (सध्या ॲक्टिव्ह - हलक्या हिरव्या बॅकग्राउंडसह) */}
  <div 
  ...
  >
    ...
    <span className="text-[10px] font-black mt-0.5 tracking-wide">प्रोफाईल</span>
  </div>
</div>
