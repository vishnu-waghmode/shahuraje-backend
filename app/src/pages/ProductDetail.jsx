      ...
      <IonContent fullscreen className="bg-gray-50">
        <div className="w-full min-h-full flex flex-col justify-between pb-24">
          ...
          <div className="bg-white px-4 pt-4 pb-3 shadow-sm sticky top-0 z-20 flex items-center justify-between">
            ...
            {/*navigate(-1) वापरल्याने युझर जिथून आला तिथेच मागे जाईल */}
            <button 
              onClick={() => navigate(-1)}
          ...
          <div className="px-4 pt-4 space-y-4">
            ...
            <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center relative">
              ...
              <span className="absolute top-4 right-4 bg-amber-50 text-amber-700 text-[10px] font-bold px-2 py-1 rounded-lg flex items-center">
                <Star size={12} className="fill-amber-500 text-amber-500 mr-1" /> 4.5 (23 रिव्ह्यूज)
              </span>

              <div className="w-full h-56 bg-gray-50 rounded-2xl mt-6 overflow-hidden flex items-center justify-center">
                <img 
                  src="https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=500" 
                  alt="Product" 
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
              <h2 className="text-lg font-black text-gray-900 leading-snug">
                TATA रॅलिस झिंक 75% WP
              </h2>
              <p className="text-xs text-gray-500 font-medium mt-1">
                पिकांच्या उत्तम वाढीसाठी आणि मुळांच्या विकासासाठी फायदेशीर.
              </p>

              <div className="mt-3 flex items-center justify-between">
                <div>
                  <span className="text-2xl font-black text-[#0c542b]">₹450</span>
                  <span className="text-xs text-gray-400 line-through ml-2">₹550</span>
                </div>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3 bg-gray-50 border border-gray-200 px-3 py-1.5 rounded-xl">
                <button 
                  onClick={decreaseQty}
                  className="p-1 bg-white rounded-lg shadow-sm text-gray-600 hover:bg-gray-100 active:scale-95"
                >
                  <Minus size={16} />
                </button>
            ...
            {/* ५. मुख्य वैशिष्ट्ये / फायदे */}
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 space-y-2.5">
              <h3 className="font-bold text-sm text-gray-800 mb-1">मुख्य वैशिष्ट्ये:</h3>
              <div className="flex items-start space-x-2 text-xs text-gray-600">
                <span className="text-[#0c542b] font-bold">✔</span>
                <span>पिकांची प्रतिकारशक्ती वाढवते आणि पिवळेपणा दूर करते.</span>
              </div>
              <div className="flex items-start space-x-2 text-xs text-gray-600">
                <span className="text-[#0c542b] font-bold">✔</span>
              ...
              <div className="flex items-start space-x-2 text-xs text-gray-600">
                <span className="text-[#0c542b] font-bold">✔</span>
                <span>उत्तम दर्जाची हमी व 100% ओरिजिनल उत्पादन.</span>
              </div>
            </div>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3.5 px-6 flex items-center space-x-3 z-30 shadow-lg">
            <button 
              onClick={() => alert('उत्पादन कार्टमध्ये जोडले गेले!')}
